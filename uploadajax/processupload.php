...
if(isset($_POST))
{
	...
	$DestinationDirectory	= '/home/bootstrap/bootstraplive/docs/finalfixmkasi/fixmykasi/uploadajax/uploads/'; //Upload Directory ends with / (slash)
	$Quality 				= 90;
	...
	$imagename = $ThumbPrefix.$NewImageName;
...
{	 
	...
	echo "<p> Your report was submitted succesfully </p><a href=../index.html>Home</a>";
...
*/	
	...
	$sql = "INSERT INTO $table_name_report(type ,municipality, subject, problem, name, contact, province, latitude, longitude, date, imagename)
			VALUES
				('$types','$municipality','$subject','$problem','$name','$contact','$province','$latitude','$longitude','12-12-2013','$imagename')";
